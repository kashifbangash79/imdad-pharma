...
const Recovery = () => {
  ...
  useEffect(() => {
    if (showHistory) {
      axios
        .get("http://localhost:5000/recoveries")
        .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:5000/recoveries/add", form)
      .then((response) => {
        ...
        {showHistory && (
          <>
            ...
            <section className="bg-white shadow-lg rounded-lg p-4 md:p-8 max-w-4xl mx-auto">
              <h3 className="text-xl md:text-2xl font-extrabold text-gray-800 mb-4">
                Recoveries List
              </h3>
              <div className="overflow-x-auto">
                <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-sm">
                  <thead>
                    <tr>
                      <th className="py-3 px-2 md:px-6 bg-gray-100 text-left text-base md:text-lg font-semibold text-gray-700 border-b">
                        #
                      </th>
                      <th className="py-3 px-2 md:px-6 bg-gray-100 text-left text-base md:text-lg font-semibold text-gray-700 border-b">
                        Customer Name
